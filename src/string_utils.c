...
STRINGUTILS_DLLEXPORT inline size_t string_common_prefix(const char *str1, const char *str2) {
...
STRINGUTILS_DLLEXPORT inline size_t string_common_suffix(const char *str1, const char *str2) {
...
STRINGUTILS_DLLEXPORT inline bool string_starts_with(const char *str, const char *start) {
    for (; *start; str++, start++)
        if (*str != *start)
            return false;
    return true;
...
STRINGUTILS_DLLEXPORT inline bool string_ends_with(const char *str, const char *ending) {
...
STRINGUTILS_DLLEXPORT inline bool string_equals(const char *s1, const char *s2) {
    if (s1 == NULL || s2  == NULL) return false;
    return strcmp(s1, s2) == 0;
}

STRINGUTILS_DLLEXPORT inline void string_upper(char *s) {
    for (; *s; ++s) *s = toupper(*s);
}

STRINGUTILS_DLLEXPORT inline char *string_replace_char(char *str, char c1, char c2) {
...
STRINGUTILS_DLLEXPORT inline bool string_is_upper(char *s) {
    for (; *s; ++s) {
...
STRINGUTILS_DLLEXPORT inline void string_lower(char *s) {
    for (; *s; ++s) *s = tolower(*s);
}

STRINGUTILS_DLLEXPORT inline bool string_is_lower(char *s) {
    for (; *s; ++s) {
...
STRINGUTILS_DLLEXPORT char *utf8_reversed_string(const char *s) {
    int32_t unich;
...
STRINGUTILS_DLLEXPORT char *utf8_case(const char *s, casing_option_t casing, utf8proc_option_t options) {
...
STRINGUTILS_DLLEXPORT inline char *utf8_lower_options(const char *s, utf8proc_option_t options) {
    return utf8_case(s, UTF8_LOWER, options);
}

STRINGUTILS_DLLEXPORT inline char *utf8_lower(const char *s) {
    return utf8_case(s, UTF8_LOWER, UTF8PROC_OPTIONS_NFC);
}

STRINGUTILS_DLLEXPORT inline char *utf8_upper_options(const char *s, utf8proc_option_t options) {
    return utf8_case(s, UTF8_UPPER, options);
}

STRINGUTILS_DLLEXPORT inline char *utf8_upper(const char *s) {
    return utf8_case(s, UTF8_UPPER, UTF8PROC_OPTIONS_NFC);
}


STRINGUTILS_DLLEXPORT inline bool utf8_is_letter(int cat) {
...
STRINGUTILS_DLLEXPORT inline bool utf8_is_number(int cat) {
    return cat == UTF8PROC_CATEGORY_ND || cat == UTF8PROC_CATEGORY_NL || cat == UTF8PROC_CATEGORY_NO;
}

STRINGUTILS_DLLEXPORT inline bool utf8_is_letter_or_number(int cat) {
    return cat == UTF8PROC_CATEGORY_LL || cat == UTF8PROC_CATEGORY_LU        \
            || cat == UTF8PROC_CATEGORY_LT || cat == UTF8PROC_CATEGORY_LO    \
...
STRINGUTILS_DLLEXPORT inline bool utf8_is_hyphen(int32_t ch) {
    int cat = utf8proc_category(ch);
    return cat == UTF8PROC_CATEGORY_PD || ch == 0x2212;
}

STRINGUTILS_DLLEXPORT inline bool utf8_is_punctuation(int cat) {
...
STRINGUTILS_DLLEXPORT inline int utf8_compare(const char *str1, const char *str2) {
...
STRINGUTILS_DLLEXPORT inline size_t utf8_common_prefix_ignore_separators(const char *str1, const char *str2) {
...
STRINGUTILS_DLLEXPORT inline bool string_contains_hyphen_len(char *str, size_t len) {
    return string_next_hyphen_index(str, len) >= 0;
}

STRINGUTILS_DLLEXPORT inline bool string_contains_hyphen(char *str) {
    return string_next_hyphen_index(str, strlen(str)) >= 0;
}

STRINGUTILS_DLLEXPORT size_t string_right_spaces_len(char *str, size_t len) {
    size_t spaces = 0;
...
STRINGUTILS_DLLEXPORT size_t string_left_spaces_len(char *str, size_t len) {
    size_t spaces = 0;
...
STRINGUTILS_DLLEXPORT inline char *char_array_get_string(char_array *array) {
...
STRINGUTILS_DLLEXPORT inline char *char_array_to_string(char_array *array) {
    if (array->n == 0 || array->a[array->n - 1] != '\0') {
        char_array_terminate(array);
    }
    char *a = array->a;
...
STRINGUTILS_DLLEXPORT inline void char_array_strip_nul_byte(char_array *array) {
    if (array->n > 0 && array->a[array->n - 1] == '\0') {
        array->a[array->n - 1] = '\0';
        array->n--;
    }
...
STRINGUTILS_DLLEXPORT inline size_t char_array_len(char_array *array) {
    if (array->n > 0 && array->a[array->n - 1] == '\0') {
        return array->n - 1;
    } else {
        return array->n;
...
STRINGUTILS_DLLEXPORT inline void char_array_append(char_array *array, char *str) {
    while(*str) {
        char_array_push(array, *str++);
    }    
}

STRINGUTILS_DLLEXPORT inline void char_array_append_len(char_array *array, char *str, size_t len) {
    for (size_t i = 0; i < len; i++) {
        char_array_push(array, *str++);
    }
}

STRINGUTILS_DLLEXPORT inline void char_array_append_reversed_len(char_array *array, char *str, size_t len) {
    int32_t unich;
    ssize_t char_len;
...
STRINGUTILS_DLLEXPORT inline void char_array_append_reversed(char_array *array, char *str) {
    size_t len = strlen(str);
    char_array_append_reversed_len(array, str, len);
}

STRINGUTILS_DLLEXPORT inline void char_array_terminate(char_array *array) {
    char_array_push(array, '\0');
}

STRINGUTILS_DLLEXPORT inline void char_array_cat(char_array *array, char *str) {
    char_array_strip_nul_byte(array);
    char_array_append(array, str);
    char_array_terminate(array);
}

STRINGUTILS_DLLEXPORT inline void char_array_cat_len(char_array *array, char *str, size_t len) {
    char_array_strip_nul_byte(array);
...
STRINGUTILS_DLLEXPORT inline void char_array_cat_reversed(char_array *array, char *str) {
    char_array_strip_nul_byte(array);
...
STRINGUTILS_DLLEXPORT inline void char_array_cat_reversed_len(char_array *array, char *str, size_t len) {
    char_array_strip_nul_byte(array);
    char_array_append_reversed_len(array, str, len);
    char_array_terminate(array);
}

STRINGUTILS_DLLEXPORT inline void char_array_add(char_array *array, char *str) {
    char_array_append(array, str);
    char_array_terminate(array);
}

STRINGUTILS_DLLEXPORT inline void char_array_add_len(char_array *array, char *str, size_t len) {
    char_array_append_len(array, str, len);
    char_array_terminate(array);
}
...
STRINGUTILS_DLLEXPORT inline void char_array_add_joined(char_array *array, char *separator, bool strip_separator, int count, ...) {
    va_list args;
    va_start(args, count);
...
STRINGUTILS_DLLEXPORT inline void char_array_cat_joined(char_array *array, char *separator, bool strip_separator, int count, ...) {
    char_array_strip_nul_byte(array);
    va_list args;
    va_start(args, count);
    char_array_add_vjoined(array, separator, strip_separator, count, args);
...
STRINGUTILS_DLLEXPORT inline size_t cstring_array_capacity(cstring_array *self) {
    return self->str->m;
}

STRINGUTILS_DLLEXPORT inline size_t cstring_array_used(cstring_array *self) {
    return self->str->n;
}

STRINGUTILS_DLLEXPORT inline size_t cstring_array_num_strings(cstring_array *self) {
    if (self == NULL) return 0;
    return self->indices->n;
}

STRINGUTILS_DLLEXPORT inline void cstring_array_resize(cstring_array *self, size_t size) {
...
STRINGUTILS_DLLEXPORT inline uint32_t cstring_array_start_token(cstring_array *self) {
    uint32_t index = (uint32_t)self->str->n;
    uint32_array_push(self->indices, index);
    return index;
}

STRINGUTILS_DLLEXPORT inline void cstring_array_terminate(cstring_array *self) {
    char_array_terminate(self->str);
}

STRINGUTILS_DLLEXPORT inline uint32_t cstring_array_add_string(cstring_array *self, char *str) {
...
STRINGUTILS_DLLEXPORT inline uint32_t cstring_array_add_string_len(cstring_array *self, char *str, size_t len) {
    uint32_t index = cstring_array_start_token(self);
...
STRINGUTILS_DLLEXPORT inline void cstring_array_append_string(cstring_array *self, char *str) {
    char_array_append(self->str, str);
}

STRINGUTILS_DLLEXPORT inline void cstring_array_append_string_len(cstring_array *self, char *str, size_t len) {
    char_array_append_len(self->str, str, len);
}

STRINGUTILS_DLLEXPORT inline void cstring_array_cat_string(cstring_array *self, char *str) {
    char_array_cat(self->str, str);
}

STRINGUTILS_DLLEXPORT inline void cstring_array_cat_string_len(cstring_array *self, char *str, size_t len) {
    char_array_cat_len(self->str, str, len);
}

STRINGUTILS_DLLEXPORT inline int32_t cstring_array_get_offset(cstring_array *self, uint32_t i) {
...
STRINGUTILS_DLLEXPORT inline char *cstring_array_get_string(cstring_array *self, uint32_t i) {
    int32_t data_index = cstring_array_get_offset(self, i);
    if (data_index < 0) return NULL;
    return self->str->a + data_index;
}

STRINGUTILS_DLLEXPORT inline int64_t cstring_array_token_length(cstring_array *self, uint32_t i) {
    if (INVALID_INDEX(i, self->indices->n)) {
        return -1;
    }
...
STRINGUTILS_DLLEXPORT inline char *string_tree_get_alternative(string_tree_t *self, size_t token_index, uint32_t alternative) {
...
STRINGUTILS_DLLEXPORT inline void string_tree_finalize_token(string_tree_t *self) {
    uint32_array_push(self->token_indices, (uint32_t)cstring_array_num_strings(self->strings));
}

// terminated
STRINGUTILS_DLLEXPORT inline void string_tree_add_string(string_tree_t *self, char *str) {
    cstring_array_add_string(self->strings, str);
}

STRINGUTILS_DLLEXPORT inline void string_tree_add_string_len(string_tree_t *self, char *str, size_t len) {
...
STRINGUTILS_DLLEXPORT inline void string_tree_append_string_len(string_tree_t *self, char *str, size_t len) {
    cstring_array_append_string_len(self->strings, str, len);
}

STRINGUTILS_DLLEXPORT inline uint32_t string_tree_num_tokens(string_tree_t *self) {
    return (uint32_t)self->token_indices->n - 1;
}

STRINGUTILS_DLLEXPORT inline uint32_t string_tree_num_strings(string_tree_t *self) {
    return (uint32_t)cstring_array_num_strings(self->strings);
}

STRINGUTILS_DLLEXPORT inline uint32_t string_tree_num_alternatives(string_tree_t *self, uint32_t i) {
