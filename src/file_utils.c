...
FILEUTILS_DLLEXPORT inline uint64_t file_deserialize_uint64(unsigned char *buf) {
...
FILEUTILS_DLLEXPORT inline uint32_t file_deserialize_uint32(unsigned char *buf) {
...
FILEUTILS_DLLEXPORT inline uint16_t file_deserialize_uint16(unsigned char *buf) {
