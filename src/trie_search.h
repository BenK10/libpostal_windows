...
#ifdef _WIN32
#    define TRIESEARCH_DLLEXPORT __declspec(dllexport)
#elif __GNUC__ >= 4
#  define TRIESEARCH_DLLEXPORT __attribute__ ((visibility("default")))
#else
#  define TRIESEARCH_DLLEXPORT
#endif
...
TRIESEARCH_DLLEXPORT phrase_array *trie_search_tokens(trie_t *self, char *str, token_array *tokens);
