...
#ifdef _WIN32
#    define TRANSLITERATE_DLLEXPORT __declspec(dllexport)
#elif __GNUC__ >= 4
#  define TRANSLITERATE_DLLEXPORT __attribute__ ((visibility("default")))
#else
#  define TRANSLITERATE_DLLEXPORT
#endif
...
TRANSLITERATE_DLLEXPORT char *transliterate(char *trans_name, char *str, size_t len);
...
TRANSLITERATE_DLLEXPORT bool transliteration_module_setup(char *filename);
TRANSLITERATE_DLLEXPORT void transliteration_module_teardown(void);
